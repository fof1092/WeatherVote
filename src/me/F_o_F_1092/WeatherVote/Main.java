...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		try {
			...
			URL meineurl = new URL("http://fof1092.de/plugins/WeatherVote.txt");
			...
			if (!in.readLine().equals("Version: 1.0")) {
