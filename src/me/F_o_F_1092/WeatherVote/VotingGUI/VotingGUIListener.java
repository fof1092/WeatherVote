...
public class VotingGUIListener {
	...
	static List<VotingGUIPlayer> voitingGuiPlayers = new ArrayList<VotingGUIPlayer>();
	...
	public static void addVotingGUIPlayer(UUID uuid, String worldName) {
		...
		if (VersionManager.getBukkitVersion() == BukkitVersion.v1_7_R1 ||
			...
			votingGUIPlayer = new me.F_o_F_1092.WeatherVote.VotingGUI.MC_V1_7__V1_12.VotingGUIPlayer(uuid, worldName);
		} else {
